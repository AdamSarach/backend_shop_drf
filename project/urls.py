...
urlpatterns = [
    ...
    path('api/orders/<int:pk>/items', views.OrderItemCreate.as_view(), name='order-detail'),
    path('api/orders/<int:pk>/items/<int:item>', views.OrderItemDetail.as_view(), name='order-detail'),
